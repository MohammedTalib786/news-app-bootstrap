    ...
    return (
        <div className="card" style={{ width: "20rem" }}>
            ...
            <div className="card-body">
                <h5 className="card-title">{title == null ? 'Sorry! Title is not Available at the Moment' : title.slice(0, 60)}</h5>
                <p className="card-text">{description == null ? 'Sorry! Description is not Available at the Moment' : description.slice(0, 110)}</p>
                <p className="card-text fw-bold   ">{author == null ? 'Unknown Author' : author}</p>
